...
public final class QRCodeWriter implements Writer {
	...
	public BitMatrix encode(String contents, BarcodeFormat format, int width, int height,
		...
		if (hints != null) {
			com.google.zxing.qrcode.decoder.ErrorCorrectionLevel requestedECLevel = (com.google.zxing.qrcode.decoder.ErrorCorrectionLevel) hints.get(EncodeHintType.ERROR_CORRECTION);
