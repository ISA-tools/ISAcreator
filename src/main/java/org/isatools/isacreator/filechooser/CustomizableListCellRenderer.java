...
/**
 * CustomListCellRenderer to customise the look of the JList
 */
public abstract class CustomizableListCellRenderer extends JComponent
        implements ListCellRenderer {
    DefaultListCellRenderer listCellRenderer;

    protected JLabel image;

    public CustomizableListCellRenderer() {
