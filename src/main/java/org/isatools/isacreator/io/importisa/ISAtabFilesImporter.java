 ...
 *         Time: 14:27
 */
public class ISAtabFilesImporter {
     ...
     */
    public ISAtabFilesImporter(ISAcreator isacreator) {
     ...
     */
    public ISAtabFilesImporter(ISAcreator isacreator, Boolean constructWithGUIs) {
