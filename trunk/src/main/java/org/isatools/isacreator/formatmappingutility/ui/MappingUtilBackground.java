...
public class MappingUtilBackground extends GenericPanel {

    private static Image logo = new ImageIcon(MappingUtilBackground.class.getResource("/images/effects/mapping_tool_logo.png")).getImage();
    private static Image notes = new ImageIcon(MappingUtilBackground.class.getResource("/images/effects/mapping_info.png")).getImage();
    ...
    protected void drawCentralPanel(Graphics2D g2, int width, int height) {
        // do nothing here. don't want anything in the center!
    }
