...
public class Utils {
    ...
    public static void reformResultData(Publication p, JEditorPane htmlPane) {
        ...
        if (p != null) {
            ...
            result.append("<span class=\"titleFont\">").append(p.getPublicationTitle()).append("</span><p/>");
            result.append("<span class=\"authorFont\">").append(p.getPublicationAuthorList()).append("</span><p/>");
