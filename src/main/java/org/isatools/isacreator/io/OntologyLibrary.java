...
public class OntologyLibrary implements Serializable {
    ...
    /**
     * Map is this way for legacy reasons because i forgot to use the Generic Map instead of the HashMap.
     *
     * @return HashMap<String, OntologySourceRefObject>
     */
    public Map<String, OntologySourceRefObject> getOntologySources() {
