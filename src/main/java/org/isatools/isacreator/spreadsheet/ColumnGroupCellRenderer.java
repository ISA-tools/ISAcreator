...
public class ColumnGroupCellRenderer extends DefaultTableCellRenderer {
    private Map<Integer, Color> columnColors;

    /**
     * Creates a ColumnGroupCellRenderer.
     */
    public ColumnGroupCellRenderer(Map<Integer, Color> columnColors) {
        super();
