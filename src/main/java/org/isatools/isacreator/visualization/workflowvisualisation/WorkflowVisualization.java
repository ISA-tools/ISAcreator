package org.isatools.isacreator.visualization.workflowvisualisation;
 ...
 *         Time: 18:09
 */
public class WorkflowVisualization extends Display {
    ...
    public WorkflowVisualization(Tree t, String label) {
    ...
    public static JComponent demo(String datafile, final String label) {
        ...
        final TreeView tview = new TreeView(t, new Dimension(800, 600), label, 2);
