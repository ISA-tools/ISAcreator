...
public class IncomingFileDataCellRenderer extends DefaultTableCellRenderer {

    public IncomingFileDataCellRenderer() {
        super();
    }
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected,
        ...
        if (table.getSelectedColumn() == column) {
            ...
            setBackground(new Color(151, 151, 151, 100));
        } else {
            setFont(UIHelper.VER_10_PLAIN);
