...
class SpreadsheetHistory extends UndoableEditSupport {
     ...
     */
    public void add(SpreadsheetCellRange range) {
     ...
     *
     * @param clip - SpreadsheetClipboard object to be added.
     */
    ...
    void setTableModel(SpreadsheetModel model) {
        this.model = model;
    }
    ...
    private void redo(UndoableUpdate current) {
        ...
        if (range.getColumnList() != null) {
            model.extendedSetSelection(range);
        } else {
            model.setSelection(range);
        }
    ...
    class UndoableUpdate extends AbstractUndoableEdit {
        ...
        public void redo() throws CannotRedoException {
            super.redo();
            SpreadsheetHistory.this.redo(this);
        }

        public void undo() throws CannotUndoException {
            super.undo();
            SpreadsheetHistory.this.undo(this);
        }
