...
public class ExitConfirmationPanel extends JPanel {
    ...
    private void createGUI() {
        ...
        confirmExitPanel.setLayout(new BoxLayout(confirmExitPanel,
                BoxLayout.LINE_AXIS));
        confirmExitPanel.setOpaque(false);

        JLabel existLab = new JLabel("Are you sure you want to exit? ",
                JLabel.LEFT);
        ...
        confirmExitPanel.add(yesOption);
        confirmExitPanel.add(Box.createVerticalStrut(10));
        confirmExitPanel.add(noOption);
