...
public class TextCellEditor extends JTextField implements TableCellEditor {
        ...
        textEditor.addPropertyChangeListener("enteredText",
                new PropertyChangeListener() {
                    public void propertyChange(PropertyChangeEvent evt) {
                        setText(textEditor.getEnteredText());
                        stopCellEditing();
                    }
                });
    ...
    protected void fireEditingCanceled() {
        curTable.setValueAt(originalValue, curRow, curCol);
    ...
    public boolean stopCellEditing() {
        fireEditingStopped();
        textEditor.setVisible(false);
        curTable.setValueAt(textEditor.getEnteredText(), curRow, curCol);
        return true;
    }
