...
public class FactorLevelEntryGUI extends JFrame {
    ...
    public FactorLevelEntryGUI() {
        ...
        unitOCE = new OntologyCellEditor(false, false, Collections.singletonMap("Unit", new RecommendedOntology(new Ontology("", "Jun 2011", "UO", "Unit Ontology"))));
        levelOCE = new OntologyCellEditor(false, false, Collections.singletonMap("Factor", new RecommendedOntology(new Ontology("", "Jun 2011", "EFO", "Experimental Factor Ontology"))));
