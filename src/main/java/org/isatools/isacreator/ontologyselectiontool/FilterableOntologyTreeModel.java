...
public class FilterableOntologyTreeModel<T, V> extends TreeFilterModel<T, V> {

    public FilterableOntologyTreeModel(TreeNode rootNode, FilterableJTree targetTree) {
        super(rootNode, targetTree);
    }

    public DefaultMutableTreeNode createRootNode() {
        return new DefaultMutableTreeNode(countValues() + " terms from " + countKeys() + " ontologies");
    }
